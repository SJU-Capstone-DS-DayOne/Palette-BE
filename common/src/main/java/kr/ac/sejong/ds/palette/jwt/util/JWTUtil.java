...
public class JWTUtil {
    ...
    public static final Long REFRESH_TOKEN_EXP_MS = 7*24*60*60*1000L;  // 일주일
    ...
    public String createJwt(String category, Long memberId, String email, String role, Long expiredMs) {
